...
export interface AlandalSearchMeta extends JSONObject {
  genres: string[];
  sort: string[];
  status: string[];
}
...
export class AlandalSearchForm extends AdvancedSearchForm {
  ...
  constructor(initialMeta?: AlandalSearchMeta) {
    super();
    ...
    return [
      Section("filters", [
        SelectRow("genres", {
          ...
          onValueChange: Application.Selector(this as AlandalSearchForm, "updateGenres"),
        }),
        SelectRow("sort", {
          title: "Sort By",
          value: this.sort,
          ...
          minItemCount: 0,
          maxItemCount: 1,
          onValueChange: Application.Selector(this as AlandalSearchForm, "updateSort"),
        }),
        SelectRow("status", {
          title: "Status",
          value: this.status,
          ...
          minItemCount: 0,
          maxItemCount: 1,
          onValueChange: Application.Selector(this as AlandalSearchForm, "updateStatus"),
        }),
      ]),
    ];
  }
