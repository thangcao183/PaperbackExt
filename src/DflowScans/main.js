...
import { DflowScansSearchForm } from "./forms";
...
export class DflowScansExtension {
    ...
    eachListItem($, cb) {
        $(".col-lg-3.col-md-4.col-sm-6").each((_, element) => {
            ...
            if (!href || !title)
                return;
            const imageUrl = this.imageFromElement(el.find(".manga-card-image img").first());
    ...
    async getMangaDetails(mangaId) {
        ...
        const thumbnailUrl = this.imageFromElement($(".col-md-4.col-lg-3 img").first());
