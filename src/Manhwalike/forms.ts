...
export interface ManhwalikeSearchMeta extends JSONObject {
  genre: string[];
}
...
export class ManhwalikeSearchForm extends AdvancedSearchForm {
  ...
  constructor(initialMeta?: ManhwalikeSearchMeta) {
    super();
  ...
  getSearchQueryMetadata(): JSONObject {
    return {
      searchMeta: {
        genre: this.genre,
      } satisfies ManhwalikeSearchMeta,
    };
  }
