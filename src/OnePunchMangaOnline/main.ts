...
const THUMBNAIL =
  "https://1punchman.com/wp-content/uploads/2024/02/9782380712018_1_75.jpg";
...
type OnePunchMangaOnlineImplementation = Extension &
  SearchResultsProviding &
  MangaProviding &
  ChapterProviding &
  CloudflareBypassRequestProviding &
...
export class OnePunchMangaOnlineExtension
  implements OnePunchMangaOnlineImplementation
{
