...
export interface ReadComicOnlineSearchMeta extends JSONObject {
  status: string[];
  sort: string[];
  year: string[];
...
export const YEAR_OPTIONS = ((): { id: string; title: string }[] => {
...
export class ReadComicOnlineSearchForm extends AdvancedSearchForm {
  ...
  constructor(initialMeta?: ReadComicOnlineSearchMeta) {
    super();
  ...
  getSearchQueryMetadata(): JSONObject {
    return {
      ...
      } satisfies ReadComicOnlineSearchMeta,
    };
  }
      ...
      Section("filters", [
        SelectRow("status", {
          ...
          onValueChange: Application.Selector(
            this as ReadComicOnlineSearchForm,
            "updateStatus",
          ),
        }),
        SelectRow("sort", {
