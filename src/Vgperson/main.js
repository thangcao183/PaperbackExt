...
export class VgpersonExtension {
    ...
    async getMangaDetails(mangaId) {
        ...
        let status = "Unknown";
        if (completeText === "(Complete)")
            status = "Completed";
        else if (completeText === "(Series in Progress)")
            status = "Ongoing";
    ...
    parseSynopsis($) {
        ...
        const nodes = content.contents().toArray().slice(5);
        let out = "";
