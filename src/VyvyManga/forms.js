...
export class VyvyMangaSearchForm extends AdvancedSearchForm {
    ...
    async updateSearchType(value) {
        this.searchType = value;
        this.reloadForm();
    }
    async updateAuthorSearchType(value) {
    ...
    async updateSortType(value) {
        this.sortType = value;
        this.reloadForm();
    }
    async updateSearchDescription(value) {
        ...
        return [
            Section("filters", [
                SelectRow("search_type", {
                    ...
                    minItemCount: 0,
                    maxItemCount: 1,
                    onValueChange: Application.Selector(this, "updateSearchType"),
                }),
                SelectRow("search_description", {
                    ...
                    minItemCount: 0,
                    maxItemCount: 1,
                    onValueChange: Application.Selector(this, "updateSearchDescription"),
                }),
                InputRow("author", {
                    title: "Author",
                    value: this.author,
                ...
                SelectRow("author_search_type", {
                    ...
                    minItemCount: 0,
                    maxItemCount: 1,
                    onValueChange: Application.Selector(this, "updateAuthorSearchType"),
                }),
                SelectRow("status", {
                    title: "Status",
                    value: this.status,
                ...
                SelectRow("sort_type", {
                    ...
                    minItemCount: 0,
                    maxItemCount: 1,
                    onValueChange: Application.Selector(this, "updateSortType"),
                }),
