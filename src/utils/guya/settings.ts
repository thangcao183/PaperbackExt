...
const BASE_URL_KEY_PREFIX = "guya.baseUrlOverride.";
...
/**
 * Settings form for a Guya source. Lets the user override the base URL
 * (useful when a site changes domain).
 */
export class GuyaSettingsForm extends Form {
      ...
      Section(
        ...
        [
          ...
          ButtonRow("base_url_reset", {
            ...
            onSelect: Application.Selector<GuyaSettingsForm, () => Promise<void>>(
              this,
              "resetOverride",
            ),
          }),
