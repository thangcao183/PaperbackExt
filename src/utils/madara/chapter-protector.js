...
export async function decryptChapterProtector($) {
    ...
    const password = substringBefore(substringAfter(protectorHtml, PASSWORD_PREFIX), "';");
    const chapterDataRaw = substringBefore(substringAfter(protectorHtml, DATA_PREFIX), "';").replace(/\\\//g, "/");
