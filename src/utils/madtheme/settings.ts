...
const BASE_URL_KEY_PREFIX = "madtheme.baseUrlOverride.";
...
/**
 * Settings form for a MadTheme source. Lets the user override the base URL
 * (useful when a site changes domain).
 */
export class MadThemeSettingsForm extends Form {
