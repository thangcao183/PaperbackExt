...
const BASE_URL_KEY_PREFIX = "manga18.baseUrlOverride.";
...
/**
 * Settings form for a Manga18 source. Lets the user override the base URL
 * (useful when a site changes domain).
 */
export class Manga18SettingsForm extends Form {
    sourceName;
    defaultBaseUrl;
    override;
