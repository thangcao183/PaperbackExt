...
const BASE_URL_KEY_PREFIX = "mangacatalog.baseUrlOverride.";
 ...
 * when none is set. Trailing slashes are stripped. MangaCatalog sites change
 * domain frequently (e.g. ww12.readonepiece.com), so this is important.
 */
...
/**
 * Settings form for a MangaCatalog source. Lets the user override the base URL
 * (useful when a site changes domain).
 */
export class MangaCatalogSettingsForm extends Form {
