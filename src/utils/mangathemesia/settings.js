...
const BASE_URL_KEY_PREFIX = "mangathemesia.baseUrlOverride.";
...
/**
 * Settings form for a MangaThemesia source. Lets the user override the base
 * URL (useful when a site changes domain) without an extension update.
 */
export class MangaThemesiaSettingsForm extends Form {
    sourceName;
    defaultBaseUrl;
    override;
